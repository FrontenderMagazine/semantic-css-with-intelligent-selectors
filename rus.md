...
абсурда и может привести к **дисбалансу** между структурой и презентацией 
...
ссылки `[rel="prev"]` стрелку с помощью псевдоэлемента:
...
производительности в востроге что проще него не придумаешь. 
